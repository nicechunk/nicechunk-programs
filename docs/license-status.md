# nicechunk-programs License Status

nicechunk-programs does not currently publish a public open-source license file.
...
Before a public open-source release, the owner should choose whether nicechunk-programs uses the same license as the wider NiceChunk repository set or needs repository-specific terms.
